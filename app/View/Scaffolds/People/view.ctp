	...
	<table cellpadding="0" cellspacing="0">
		...
		<?php foreach ($betDetails as $betDetail): ?>
			...
			<tr>
				...
				<td><?php echo number_format($betDetail['BetDetail']['amount_of_bet'], 0, ',', '.'); ?>&nbsp;</td>
				<td><?php echo h($betDetail['BetDetail']['status']); ?>&nbsp;</td>
				<td><?php echo number_format($betDetail['BetDetail']['win_loss'], 0, ',', '.'); ?>&nbsp;</td>
			</tr>
		<?php endforeach; ?>
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><?php echo number_format($taob, 0, ',', '.'); ?>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&plusmn; <strong><?php echo number_format(abs($tw - $tl), 0, ',', '.'); ?></strong>&nbsp;</td>
		</tr>
	</table>
	<p>
		<?php
